...
func LoadRoute() {
	WEB.Group("/v1", func() {
		...
		WEB.Group("/device", func() {
			...
			WEB.Get("/:DeviceId:int/netPorts/?:Ipv4Int:int", GetNetPort)
			WEB.Post("/:DeviceId:int/netPorts/?:Ipv4Int:int", AddNetPort)
			WEB.Delete("/:DeviceId:int/netPorts/?:Ipv4Int:int", DelNetPort)
